...
var v8CompileCache = createCommonjsModule(function (module$1) {
...
class NativeCompileCache {
  ...
  install() {
    ...
    module.prototype._compile = function(content, filename) {
      ...
      const args = [mod.exports, require, mod, filename, dirname, process, commonjsGlobal, Buffer];
...
function getParentName() {
  ...
  const parentName = module$1.parent && typeof module$1.parent.filename === 'string'
    ? module$1.parent.filename
    : process.cwd();
  return parentName;
}
