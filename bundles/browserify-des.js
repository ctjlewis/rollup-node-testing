...
function DES$2 (opts) {
  ...
  if (modeName === 'des-ede' || modeName === 'des-ede-cbc') {
    key = Buffer$1.concat([key, key.slice(0, 8)]);
  }
  var iv = opts.iv;
  if (!Buffer$1.isBuffer(iv)) {
    iv = Buffer$1.from(iv);
  }
...
DES$2.prototype._update = function (data) {
  return Buffer$1.from(this._des.update(data))
};
DES$2.prototype._final = function () {
  return Buffer$1.from(this._des.final())
};
