...
function morgan (format, options) {
  ...
  return function logger (req, res, next) {
    ...
    if (immediate) {
      ...
      onHeaders_1(res, recordStartTime);

      // log when response finished
      onFinished_1(res, logRequest);
    }
...
morgan_1.compile = compile_1;
morgan_1.format = format_1;
morgan_1.token = token_1;
