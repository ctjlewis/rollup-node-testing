...
function isValidIdentifier(name, reserved = true) {
  ...
  if (reserved) {
    if ((0, lib$1.isKeyword)(name) || (0, lib$1.isStrictReservedWord)(name)) {
      return false;
    } else if (name === "await") {
      return false;
    }
...
(0, _utils.default)("Identifier", {
  ...
  validate(parent, key, node) {
    ...
    if (((0, lib$1.isKeyword)(node.name) || (0, lib$1.isReservedWord)(node.name)) && node.name !== "this") {
...
var _helperAnnotateAsPure = _interopRequireDefault(lib$3);
...
var _difference = _interopRequireDefault(difference_1);
...
var getComponentId = function getComponentId(state) {
  ...
  return `${(0, options.useNamespace)(state)}${(0, _prefixDigit.default)(getFileHash(state))}-${getNextId(state)}`;
};
...
var _default = function _default(t) {
  return function (path, state) {
    ...
    if (!importName || !bindings[importName.name] || !bindings[importName]) {
      (0, lib$4.addDefault)(path, 'styled-components', {
        nameHint: 'styled'
      });
