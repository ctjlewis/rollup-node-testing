...
var ed4 = createCommonjsModule(function (module, exports) {
/**
...
var xmlchars = createCommonjsModule(function (module, exports) {
/**
...
(function (XMLNS_1_0) {
    ...
    (function (ED3) {
        ...
        var fragments;
        (function (fragments) {
            fragments.NC_NAME_START_CHAR = ed3.NC_NAME_START_CHAR;
            fragments.NC_NAME_CHAR = ed3.NC_NAME_CHAR;
        ...
        var regexes;
        (function (regexes) {
            regexes.NC_NAME_START_CHAR = ed3.NC_NAME_START_CHAR_RE;
            regexes.NC_NAME_CHAR = ed3.NC_NAME_CHAR_RE;
            regexes.NC_NAME = ed3.NC_NAME_RE;
         ...
         * @returns ``true`` if the codepoint matches.
         */
        ED3.isNCNameStartChar = ed3.isNCNameStartChar;
        /**
         ...
         * @returns ``true`` if the codepoint matches.
         */
        ED3.isNCNameChar = ed3.isNCNameChar;
