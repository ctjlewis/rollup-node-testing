...
function Node(val, type, parent) {
  ...
  defineProperty(this, 'isNode', true);
  defineProperty(this, 'expect', null);
...
Node.prototype.push = function(node) {
  ...
  defineProperty(node, 'parent', this);
