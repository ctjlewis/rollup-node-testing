...
var pify_1$1 = createCommonjsModule(function (module) {
...
function type(fn, fn2, fp) {
	if (typeof fp !== 'string') {
		return pinkiePromise.reject(new TypeError('Expected a string'));
	}

	return pify_1$1(gracefulFs[fn], pinkiePromise)(fp).then(function (stats) {
		return stats[fn2]();
	});
}
