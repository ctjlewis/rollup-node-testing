...
var unzip_1 = function (req, res) {
  ...
  res.setEncoding = function (type) {
    decoder = new StringDecoder$1(type);
  ...
  unzip.on('data', function (buf) {
    if (decoder) {
      ...
      if (str.length > 0) stream$1.emit('data', str);
    } else {
...
var http2;
if (semver$1.gte(process.version, 'v10.10.0')) http2 = http2$1;else throw new Error('superagent: this version of Node.js does not support http2');
  ...
  for (var _i2 = 0, _keys2 = keys; _i2 < _keys2.length; _i2++) {
    ...
    switch (key) {
      case HTTP2_HEADER_HOST:
        ...
        value = /^http:\/\/|^https:\/\//.test(value) ? parse$3(value).host : value;
        break;
    }
...
var setProtocol_1 = setProtocol;


var http2wrapper = {
	setProtocol: setProtocol_1
};
...
var http2;
if (semver$1.gte(process.version, 'v10.10.0')) http2 = http2wrapper;
...
Request.prototype._redirect = function (res) {
  ...
  if (res.statusCode === 301 || res.statusCode === 302) {
    ...
    // in case of POST etc
    headers = utils$1.cleanHeader(headers, changesOrigin); // force GET
  ...
  if (res.statusCode === 303) {
    // strip Content-* related fields
    // in case of POST etc
    headers = utils$1.cleanHeader(headers, changesOrigin); // force method
...
Request.prototype.request = function () {
  ...
  try {
    var query = lib.stringify(this.qs, {
      indices: false,
...
Request.prototype._end = function () {
  ...
  req.once('response', function (res) {
    ...
    var mime = utils$1.type(res.headers['content-type'] || '') || 'text/plain';
    ...
    if (!parser) {
      if (responseType) {
        ...
        var form = new lib$1.IncomingForm();
