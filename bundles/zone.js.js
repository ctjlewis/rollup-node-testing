...
(function (factory) {
    ...
    Zone.__load_patch('EventEmitter', function (global) {
        ...
        if (events$1 && events$1.EventEmitter) {
            patchEventEmitterMethods(events$1.EventEmitter.prototype);
        }
    });
    /**
     * @license
    ...
    Zone.__load_patch('fs', function () {
        ...
        if (fs$1) {
            TO_PATCH_MACROTASK_METHODS.filter(function (name) { return !!fs$1[name] && typeof fs$1[name] === 'function'; })
                .forEach(function (name) {
                patchMacroTask(fs$1, name, function (self, args) {
                    return {
                        name: 'fs.' + name,
                        args: args,
    ...
    Zone.__load_patch('node_timers', function (global, Zone) {
        ...
        try {
            var timers$1 = timers;
            var globalEqualTimersTimeout = global.setTimeout === timers$1.setTimeout;
            if (!globalEqualTimersTimeout && !isMix) {
                ...
                var originSetTimeout_1 = timers$1.setTimeout;
                ...
                timers$1.setTimeout = originSetTimeout_1;
            }
            patchTimer(timers$1, set, clear, 'Timeout');
            patchTimer(timers$1, set, clear, 'Interval');
            patchTimer(timers$1, set, clear, 'Immediate');
        }
        catch (error) {
    ...
    Zone.__load_patch('crypto', function () {
        ...
        if (crypto$1) {
            ...
            methodNames.forEach(function (name) {
                patchMacroTask(crypto$1, name, function (self, args) {
                    return {
                        name: 'crypto.' + name,
                        args: args,
