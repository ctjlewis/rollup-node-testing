...
var objectPrototypeAccessorsForced = isPure ;
...
var FORCED$g = NEW_TARGET_BUG || ARGS_BUG;

_export({ target: 'Reflect', stat: true, forced: FORCED$g, sham: FORCED$g }, {
...
if (descriptors) defineProperty$6(Subscription.prototype, 'closed', {
  configurable: true,
  get: function () {
...
if (descriptors) defineProperty$6(SubscriptionObserver.prototype, 'closed', {
  configurable: true,
  get: function () {
...
var $Observable = function Observable(subscriber) {
  ...
  setInternalState$b(this, { subscriber: aFunction(subscriber) });
};
...
if (!has(asyncIteratorPrototype, TO_STRING_TAG$3)) {
  createNonEnumerableProperty(asyncIteratorPrototype, TO_STRING_TAG$3, 'AsyncIterator');
}
...
var $every$1 = asyncIteratorIteration.every;

_export({ target: 'AsyncIterator', proto: true, real: true }, {
  every: function every(fn) {
    return $every$1(this, fn);
  }
});
...
var $find$1 = asyncIteratorIteration.find;

_export({ target: 'AsyncIterator', proto: true, real: true }, {
  find: function find(fn) {
    return $find$1(this, fn);
  }
});
...
var $forEach$2 = asyncIteratorIteration.forEach;

_export({ target: 'AsyncIterator', proto: true, real: true }, {
  forEach: function forEach(fn) {
    return $forEach$2(this, fn);
  }
});
...
var $some$1 = asyncIteratorIteration.some;

_export({ target: 'AsyncIterator', proto: true, real: true }, {
  some: function some(fn) {
    return $some$1(this, fn);
  }
});
...
{
  IteratorPrototype$3 = {};
  createNonEnumerableProperty(IteratorPrototype$3, ITERATOR$7, function () {
    return this;
  });
}

if (!has(IteratorPrototype$3, TO_STRING_TAG$5)) {
...
_export({ global: true, forced: FORCED$h }, {
...
var iteratorCreateProxy = function (nextHandler, IS_ITERATOR) {
  ...
  if (!IS_ITERATOR) {
    createNonEnumerableProperty(IteratorProxy.prototype, TO_STRING_TAG$6, 'Generator');
  }
...
var $AggregateError = function AggregateError(errors, message) {
  ...
  if (descriptors) setInternalState$g(that, { errors: errorsArray, type: 'AggregateError' });
...
for (var COLLECTION_NAME in domIterables) {
  ...
  if (CollectionPrototype && classof(CollectionPrototype) !== TO_STRING_TAG$7) {
    createNonEnumerableProperty(CollectionPrototype, TO_STRING_TAG$7, COLLECTION_NAME);
  }
  iterators[COLLECTION_NAME] = iterators.Array;
}

var FORCED$i = !global_1.setImmediate || !global_1.clearImmediate;

// http://w3c.github.io/setImmediate/
_export({ global: true, bind: true, enumerable: true, forced: FORCED$i }, {
  // `setImmediate` method
